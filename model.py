...
import network_functions as net_fns
import networks
import train_util
import util
import numpy as np
...
def set_flags(flags):
  ...
  flags.set_if_empty('train_root_dir', config.train_path)
  flags.set_if_empty('train_data_path', config.train_data_path)
